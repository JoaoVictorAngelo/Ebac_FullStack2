...
function funcaoMuitoPesada() {
  var execucoes = 0; // Inicializa o contador de execuções
...
var promiseComParametros = function promiseComParametros(login, senha) {
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      resolve("Logado com o usuario: ".concat(login)); // Resolve a Promise após 3 segundos
    }, 3000);
  });
};
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          promiseComParametros('joao@gmail.com', 123321).then(function (resultado) {
        ...
        case 9:
          ...
          console.log(_context.t0); // Exibe o erro, caso ocorra
        case 12:
